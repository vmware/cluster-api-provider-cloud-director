...
We recommend CSE provisoned TKG cluster as bootstrap cluster, as LCM of the final management cluster can be 
reliably done through CSE provisioned bootstrap cluster.
