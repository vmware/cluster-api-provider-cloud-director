...
2. Fill out the values for the environment variables in `~/.cluster-api/clusterctl.yaml`.
   ...
   - If you decide to not use one of the existing clusterctl template flavors, please refer to the [TKG catalog management table](https://github.com/rliang88/rliang-capvcd/blob/rl/CAFV-460-main/docs/TKG_CATALOG_MANAGEMENT.md) on the `main` branch
