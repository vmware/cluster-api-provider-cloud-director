...
func (r *VCDMachineReconciler) reconcileNormal(ctx context.Context, cluster *clusterv1.Cluster,
	...
	if vcdCluster.Spec.UseKubeVIP {
		log.Info("Will not add machine to Avi LB since this is a Kube-VIP based cluster")
	} else {
...
func (r *VCDMachineReconciler) reconcileDelete(ctx context.Context, cluster *clusterv1.Cluster, machine *clusterv1.Machine,
	...
	// if not KubeVIP, clean up LoadBalancer
	if util.IsControlPlaneMachine(machine) && !vcdCluster.Spec.UseKubeVIP {
