...
import (
	...
	infrastructurev1beta2 "github.com/vmware/cluster-api-provider-cloud-director/api/v1beta2"
...
func TestAPIs(t *testing.T) {
	...
	// Removing printer.NewlineReporter{} as pkg/envtest/printer has been removed in controller-runtime v0.14.0+ as a result of migrating to ginkgo v2.
