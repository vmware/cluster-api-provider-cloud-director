...
# TODO Add a target to download and build conversion-gen; and then run it with the below params
# >./conversion-gen --input-dirs=./api/v1alpha4 --output-file-base=zz_generated.conversion --go-header-file=./boilerplate.go.txt --build-tag=ignore_autogenerated_conversions
