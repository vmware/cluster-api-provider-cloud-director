...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubeVIPParams) DeepCopyInto(out *KubeVIPParams) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubeVIPParams.
func (in *KubeVIPParams) DeepCopy() *KubeVIPParams {
	if in == nil {
		return nil
	}
	out := new(KubeVIPParams)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VCDClusterSpec) DeepCopyInto(out *VCDClusterSpec) {
	*out = *in
	...
	out.KubeVIPParams = in.KubeVIPParams
