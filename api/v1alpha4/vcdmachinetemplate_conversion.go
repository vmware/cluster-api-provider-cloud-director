...
// ConvertTo converts this (v1alpha4) VCDMachineTemplate to the Hub version (v1beta3).
func (src *VCDMachineTemplate) ConvertTo(dstRaw conversion.Hub) error {
	dst := dstRaw.(*v1beta3.VCDMachineTemplate)
	if err := Convert_v1alpha4_VCDMachineTemplate_To_v1beta3_VCDMachineTemplate(src, dst, nil); err != nil {
		return err
	}
...
func (dst *VCDMachineTemplate) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1beta3_VCDMachineTemplate_To_v1alpha4_VCDMachineTemplate(src, dst, nil); err != nil {
		return err
	}
...
func (src *VCDMachineTemplateList) ConvertTo(dstRaw conversion.Hub) error {
	...
	return Convert_v1alpha4_VCDMachineTemplateList_To_v1beta3_VCDMachineTemplateList(src, dst, nil)
}

// ConvertFrom converts from the Hub version (v1beta3) to this version (v1alpha4).
func (dst *VCDMachineTemplateList) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*v1beta3.VCDMachineTemplateList)
	return Convert_v1beta3_VCDMachineTemplateList_To_v1alpha4_VCDMachineTemplateList(src, dst, nil)
}
