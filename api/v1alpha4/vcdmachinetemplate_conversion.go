...
// ConvertTo converts this (v1alpha4)VCDMachineTemplate to the Hub version (v1beta1).
...
// ConvertTo converts this VCDMachineTemplateList to the Hub version (v1beta1).
