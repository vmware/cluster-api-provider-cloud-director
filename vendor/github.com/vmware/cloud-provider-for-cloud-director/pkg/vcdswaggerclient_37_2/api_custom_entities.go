 ...
 * @param optional nil or *CustomEntitiesApiGetCustomEntityTypeTenantsQueryOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
type CustomEntitiesApiGetCustomEntityTypeTenantsQueryOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *CustomEntitiesApiService) GetCustomEntityTypeTenantsQuery(ctx context.Context, customEntityTypeId string, page int32, pageSize int32, localVarOptionals *CustomEntitiesApiGetCustomEntityTypeTenantsQueryOpts) (EntityReferences, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/customEntityTypes/{customEntityTypeId}/tenants"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityTypeId"+"}", fmt.Sprintf("%v", customEntityTypeId), -1)
...
*/
func (a *CustomEntitiesApiService) PostCustomEntityTypePublishAllBounded(ctx context.Context, customEntityTypeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/customEntityTypes/{customEntityTypeId}/tenants/publishAll"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityTypeId"+"}", fmt.Sprintf("%v", customEntityTypeId), -1)
...
*/
func (a *CustomEntitiesApiService) PostCustomEntityTypePublishBounded(ctx context.Context, customEntityTypeId string, publishTenantsBody EntityReferences) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/customEntityTypes/{customEntityTypeId}/tenants/publish"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityTypeId"+"}", fmt.Sprintf("%v", customEntityTypeId), -1)
...
*/
func (a *CustomEntitiesApiService) PostCustomEntityTypeUnpublishAllBounded(ctx context.Context, customEntityTypeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/customEntityTypes/{customEntityTypeId}/tenants/unpublishAll"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityTypeId"+"}", fmt.Sprintf("%v", customEntityTypeId), -1)
...
*/
func (a *CustomEntitiesApiService) PostCustomEntityTypeUnpublishBounded(ctx context.Context, customEntityTypeId string, unpublishTenantsBody EntityReferences) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/customEntityTypes/{customEntityTypeId}/tenants/unpublish"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityTypeId"+"}", fmt.Sprintf("%v", customEntityTypeId), -1)
...
*/
func (a *CustomEntitiesApiService) SetCustomEntityTypeTenantsBounded(ctx context.Context, customEntityTypeId string, publishTenantsBody EntityReferences) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
