...
/*
UserApiService Modify the existing password of a local user.
...
*/
func (a *UserApiService) ChangePassword(ctx context.Context, passwordChangeRequest PasswordChangeRequest, userUrn string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/users/{userUrn}/changePassword"
	...
	// body params
	localVarPostBody = &passwordChangeRequest
	if ctx != nil {
...
/*
UserApiService Get a specified user by id. If the id of a service account is specified instead, a simplified view of the service account is returned instead. 
...
/*
UserApiService Transfer ownership of this user&#39;s owned entities to the caller.
...
*/
func (a *UserApiService) TakeOwnership(ctx context.Context, userUrn string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/users/{userUrn}/takeOwnership"
	localVarPath = strings.Replace(localVarPath, "{"+"userUrn"+"}", fmt.Sprintf("%v", userUrn), -1)
