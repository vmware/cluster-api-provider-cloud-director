 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CellApiGetCellGroupCurrentTopologyStatusOpts - Optional Parameters:
...
@return CellGroupTopologyStatus
*/

type CellApiGetCellGroupCurrentTopologyStatusOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *CellApiService) GetCellGroupCurrentTopologyStatus(ctx context.Context, localVarOptionals *CellApiGetCellGroupCurrentTopologyStatusOpts) (CellGroupTopologyStatus, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue CellGroupTopologyStatus
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/cells/current/topology"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CellApiGetCellGroupTopologyStatusOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
type CellApiGetCellGroupTopologyStatusOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *CellApiService) GetCellGroupTopologyStatus(ctx context.Context, localVarOptionals *CellApiGetCellGroupTopologyStatusOpts) (CellGroupTopologyStatus, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/cells/topology"
 ...
 * @param optional nil or *CellApiGetCellTopologyHistoryOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort

@return CellTopologyHistory
*/

type CellApiGetCellTopologyHistoryOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *CellApiService) GetCellTopologyHistory(ctx context.Context, cellUrn string, page int32, pageSize int32, localVarOptionals *CellApiGetCellTopologyHistoryOpts) (CellTopologyHistory, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue CellTopologyHistory
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/cells/{cellUrn}/topology"
	localVarPath = strings.Replace(localVarPath, "{"+"cellUrn"+"}", fmt.Sprintf("%v", cellUrn), -1)
