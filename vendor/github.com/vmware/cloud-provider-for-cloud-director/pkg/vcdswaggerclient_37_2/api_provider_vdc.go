...
/*
ProviderVdcApiService Get all provider VDCs that are valid merge candidates to be merged into the specified target provider VDC.
Return PVDCs that can merge with the given target PVDC urn. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param pvdcUrn
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *ProviderVdcApiGetMergeCandidatesForPvdcOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
type ProviderVdcApiGetMergeCandidatesForPvdcOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *ProviderVdcApiService) GetMergeCandidatesForPvdc(ctx context.Context, pvdcUrn string, page int32, pageSize int32, localVarOptionals *ProviderVdcApiGetMergeCandidatesForPvdcOpts) (ProviderVdcs, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/providerVdcs/{pvdcUrn}/mergeCandidates"
	localVarPath = strings.Replace(localVarPath, "{"+"pvdcUrn"+"}", fmt.Sprintf("%v", pvdcUrn), -1)
