...
/*
ExternalNetworkApiService Retrieve information about all the Edge Gateways which are associated with the Provider Gateway. This endpoint is only supported for external networks which are backed by NSX-T Tier-0 router. 
 ...
 * @param externalNetworkId
 * @param optional nil or *ExternalNetworkApiGetEdgeGatewaysForProviderGatewayTopologyOpts - Optional Parameters:
...
@return TopologyEdgeGateways
*/

type ExternalNetworkApiGetEdgeGatewaysForProviderGatewayTopologyOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *ExternalNetworkApiService) GetEdgeGatewaysForProviderGatewayTopology(ctx context.Context, page int32, pageSize int32, externalNetworkId string, localVarOptionals *ExternalNetworkApiGetEdgeGatewaysForProviderGatewayTopologyOpts) (TopologyEdgeGateways, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue TopologyEdgeGateways
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/externalNetworks/{externalNetworkId}/topology/edgeGateways"
	localVarPath = strings.Replace(localVarPath, "{"+"externalNetworkId"+"}", fmt.Sprintf("%v", externalNetworkId), -1)
...
/*
ExternalNetworkApiService Retrieve information about all the IP Space uplinks which are associated with the Provider Gateway. This endpoint is only supported for external networks which are backed by NSX-T Tier-0 router. 
Get all the IP Space uplinks which are associated with this Provider Gateway. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param externalNetworkId
 * @param optional nil or *ExternalNetworkApiGetIpSpaceUplinksForProviderGatewayTopologyOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort

@return TopologyIpSpaceUplinks
*/

type ExternalNetworkApiGetIpSpaceUplinksForProviderGatewayTopologyOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *ExternalNetworkApiService) GetIpSpaceUplinksForProviderGatewayTopology(ctx context.Context, page int32, pageSize int32, externalNetworkId string, localVarOptionals *ExternalNetworkApiGetIpSpaceUplinksForProviderGatewayTopologyOpts) (TopologyIpSpaceUplinks, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue TopologyIpSpaceUplinks
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/externalNetworks/{externalNetworkId}/topology/ipSpaceUplinks"
	localVarPath = strings.Replace(localVarPath, "{"+"externalNetworkId"+"}", fmt.Sprintf("%v", externalNetworkId), -1)
