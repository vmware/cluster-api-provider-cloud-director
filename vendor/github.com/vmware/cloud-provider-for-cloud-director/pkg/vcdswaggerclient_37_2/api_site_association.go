...
type SiteAssociationApiService service

/*
SiteAssociationApiService Get specified site association.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Site Association ID Urn

@return SiteAssociation
*/
func (a *SiteAssociationApiService) GetSiteAssociation(ctx context.Context, id string) (SiteAssociation, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue SiteAssociation
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/site/associations/{id}"
...
/*
SiteAssociationApiService Get list of site associations accessible to the user.
 ...
 * @param optional nil or *SiteAssociationApiQuerySiteAssociationsOpts - Optional Parameters:
...
type SiteAssociationApiQuerySiteAssociationsOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *SiteAssociationApiService) QuerySiteAssociations(ctx context.Context, page int32, pageSize int32, localVarOptionals *SiteAssociationApiQuerySiteAssociationsOpts) (SiteAssociations, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue SiteAssociations
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/site/associations"
