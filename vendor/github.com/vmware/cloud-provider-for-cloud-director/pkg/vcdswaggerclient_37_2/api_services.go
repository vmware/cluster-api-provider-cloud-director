...
/*
ServicesApiService Retrieves paginated list of tenants for whom the service item is explicitly published
 ...
 * @param optional nil or *ServicesApiGetServiceItemTenantsQueryOpts - Optional Parameters:
...
type ServicesApiGetServiceItemTenantsQueryOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *ServicesApiService) GetServiceItemTenantsQuery(ctx context.Context, id string, page int32, pageSize int32, localVarOptionals *ServicesApiGetServiceItemTenantsQueryOpts) (EntityReferences, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/serviceItem/{id}/tenants"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
*/
func (a *ServicesApiService) PostServiceItemPublishAllBounded(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/serviceItem/{id}/tenants/publishAll"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
*/
func (a *ServicesApiService) PostServiceItemPublishBounded(ctx context.Context, id string, publishTenantsBody EntityReferences) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/serviceItem/{id}/tenants/publish"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
*/
func (a *ServicesApiService) PostServiceItemUnpublishAllBounded(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/serviceItem/{id}/tenants/unpublishAll"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
*/
func (a *ServicesApiService) PostServiceItemUnpublishBounded(ctx context.Context, id string, unpublishTenantsBody EntityReferences) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/serviceItem/{id}/tenants/unpublish"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
*/
func (a *ServicesApiService) SetServiceItemTenantsBounded(ctx context.Context, id string, publishTenantsBody EntityReferences) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
