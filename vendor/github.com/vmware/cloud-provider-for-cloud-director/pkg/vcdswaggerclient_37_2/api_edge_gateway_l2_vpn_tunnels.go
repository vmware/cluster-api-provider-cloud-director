...
func (a *EdgeGatewayL2VpnTunnelsApiService) GetL2VpnTunnels(ctx context.Context, pageSize int32, gatewayId string, localVarOptionals *EdgeGatewayL2VpnTunnelsApiGetL2VpnTunnelsOpts) (EdgeL2VpnTunnels, *http.Response, error) {
	var (
