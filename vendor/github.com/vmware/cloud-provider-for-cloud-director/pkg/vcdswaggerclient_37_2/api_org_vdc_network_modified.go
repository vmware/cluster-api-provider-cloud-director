...
/*
OrgVdcNetworkApiService Returns the additional properties of a specific Org vDC network. This is a System Administrator only API.
...
*/
func (a *OrgVdcNetworkApiService) GetAdditionalProperties(ctx context.Context, vdcNetworkId string) (OrgVdcNetworkAdditionalProperties, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue OrgVdcNetworkAdditionalProperties
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/orgVdcNetworks/{vdcNetworkId}/additionalProperties"
	localVarPath = strings.Replace(localVarPath, "{"+"vdcNetworkId"+"}", fmt.Sprintf("%v", vdcNetworkId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v OrgVdcNetworkAdditionalProperties
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
...
/*
OrgVdcNetworkApiService Retrieves the segment profiles configuration for an Org vDC Network.
Retrieves the segment profiles configured for an Org vDC Network. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param vdcNetworkId

@return VdcNetworkSegmentProfileConfig
*/
func (a *OrgVdcNetworkApiService) GetNetworkSegmentProfiles(ctx context.Context, vdcNetworkId string) (VdcNetworkSegmentProfileConfig, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue VdcNetworkSegmentProfileConfig
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/orgVdcNetworks/{vdcNetworkId}/segmentProfiles"
	localVarPath = strings.Replace(localVarPath, "{"+"vdcNetworkId"+"}", fmt.Sprintf("%v", vdcNetworkId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v VdcNetworkSegmentProfileConfig
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
OrgVdcNetworkApiService Updates the segment profiles configuration for an Org vDC Network.
Updates the segment profiles configuration for an Org vDC Network. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param networkSegmentProfiles
 * @param vdcNetworkId


*/
func (a *OrgVdcNetworkApiService) UpdateNetworkSegmentProfiles(ctx context.Context, networkSegmentProfiles VdcNetworkSegmentProfileConfig, vdcNetworkId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// body params
	localVarPostBody = &networkSegmentProfiles
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
