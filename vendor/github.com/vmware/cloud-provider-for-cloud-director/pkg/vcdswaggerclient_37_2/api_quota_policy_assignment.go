...
/*
QuotaPolicyAssignmentApiService Assign or unassign a quota policy to a given target service account. An empty payload is used to unassign an existing quota policy from a given service account. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param quotaPolicyReference
 * @param serviceAccountUrn


*/
func (a *QuotaPolicyAssignmentApiService) AssignQuotaPolicyToServiceAccount(ctx context.Context, quotaPolicyReference AssignedQuotaPolicy, serviceAccountUrn string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/serviceAccounts/{serviceAccountUrn}/quotaPolicy"
	localVarPath = strings.Replace(localVarPath, "{"+"serviceAccountUrn"+"}", fmt.Sprintf("%v", serviceAccountUrn), -1)
...
/*
QuotaPolicyAssignmentApiService Get the assigned quota policy reference for the given service account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serviceAccountUrn

@return AssignedQuotaPolicy
*/
func (a *QuotaPolicyAssignmentApiService) GetServiceAccountAssignedQuotaPolicy(ctx context.Context, serviceAccountUrn string) (AssignedQuotaPolicy, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
