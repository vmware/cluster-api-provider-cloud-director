...
type MultiVcVmsApiService service

/*
MultiVcVmsApiService Delete the specified Multi VC VM.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param multiVcVmUrn


*/
func (a *MultiVcVmsApiService) DeleteMultiVcVm(ctx context.Context, multiVcVmUrn string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/multiVcVms/{multiVcVmUrn}"
	localVarPath = strings.Replace(localVarPath, "{"+"multiVcVmUrn"+"}", fmt.Sprintf("%v", multiVcVmUrn), -1)
...
/*
MultiVcVmsApiService Get the Multi VC VM with the specified ID.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param multiVcVmUrn

@return MultiVcVm
*/
func (a *MultiVcVmsApiService) GetMultiVcVm(ctx context.Context, multiVcVmUrn string) (MultiVcVm, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue MultiVcVm
	)
...
/*
MultiVcVmsApiService Get all Multi VC VMs in the system.
 ...
 * @param optional nil or *MultiVcVmsApiGetMultiVcVmsOpts - Optional Parameters:
...
type MultiVcVmsApiGetMultiVcVmsOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *MultiVcVmsApiService) GetMultiVcVms(ctx context.Context, page int32, pageSize int32, localVarOptionals *MultiVcVmsApiGetMultiVcVmsOpts) (MultiVcVms, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue MultiVcVms
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/multiVcVms"
