...
type VgpuProfilesApiService service

/*
VgpuProfilesApiService Delete specified vGPU profile.
...
*/
func (a *VgpuProfilesApiService) DeleteVgpuProfile(ctx context.Context, vgpuProfileId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vgpuProfiles/{vgpuProfileId:((?!consumers|commonVgpuProfile|vgpuProfileConsumer).)*}"
	localVarPath = strings.Replace(localVarPath, "{"+"vgpuProfileId"+"}", fmt.Sprintf("%v", vgpuProfileId), -1)
...
/*
VgpuProfilesApiService Get specified vGPU profile
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param vgpuProfileId

@return VgpuProfile
*/
func (a *VgpuProfilesApiService) GetVgpuProfile(ctx context.Context, vgpuProfileId string) (VgpuProfile, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue VgpuProfile
	)
...
/*
VgpuProfilesApiService Get list of vGPU profiles
 ...
 * @param optional nil or *VgpuProfilesApiQueryVgpuProfilesOpts - Optional Parameters:
...
type VgpuProfilesApiQueryVgpuProfilesOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *VgpuProfilesApiService) QueryVgpuProfiles(ctx context.Context, page int32, pageSize int32, localVarOptionals *VgpuProfilesApiQueryVgpuProfilesOpts) (VgpuProfiles, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue VgpuProfiles
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vgpuProfiles"
...
/*
VgpuProfilesApiService Update specified vGPU profile
vGPU profile&#39;s name cannot be updated but other information such as tenantFacingName and instructions can be updated. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param updatedVgpuProfile
 * @param vgpuProfileId

@return VgpuProfile
*/
func (a *VgpuProfilesApiService) UpdateVgpuProfile(ctx context.Context, updatedVgpuProfile VgpuProfile, vgpuProfileId string) (VgpuProfile, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &updatedVgpuProfile
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
