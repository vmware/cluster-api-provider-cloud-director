...
/*
DefinedInterfaceBehaviorsApiService Download the execution log from a behavior invocation
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param id
  - @param behaviorId
  - @param invocationId
...
@return string
*/
func (a *DefinedInterfaceBehaviorsApiService) GetBehaviorExecutionLog(ctx context.Context, id string, behaviorId string, invocationId string) (string, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/entities/{id}/behaviors/{behaviorId}/invocations/{invocationId}/log"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"behaviorId"+"}", fmt.Sprintf("%v", behaviorId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"invocationId"+"}", fmt.Sprintf("%v", invocationId), -1)
