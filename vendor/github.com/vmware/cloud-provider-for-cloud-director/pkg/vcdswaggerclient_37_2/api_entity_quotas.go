...
/*
EntityQuotasApiService Assign quotas to given target service account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param quotas
...
*/
func (a *EntityQuotasApiService) AssignQuotasToServiceAccount(ctx context.Context, quotas Quotas, serviceAccountUrn string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/serviceAccounts/{serviceAccountUrn}/quotas"
...
/*
EntityQuotasApiService Get the effective quotas applicable for the given service account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serviceAccountUrn

@return Quotas
*/
func (a *EntityQuotasApiService) GetQuotasForServiceAccount(ctx context.Context, serviceAccountUrn string) (Quotas, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
