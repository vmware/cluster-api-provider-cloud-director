 ...
 * @param optional nil or *VirtualCenterApiGetAllResourcePoolsOpts - Optional Parameters:
...
type VirtualCenterApiGetAllResourcePoolsOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *VirtualCenterApiService) GetAllResourcePools(ctx context.Context, vcUrn string, page int32, pageSize int32, localVarOptionals *VirtualCenterApiGetAllResourcePoolsOpts) (ResourcePools, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/virtualCenters/{vcUrn}/resourcePools/browseAll"
	localVarPath = strings.Replace(localVarPath, "{"+"vcUrn"+"}", fmt.Sprintf("%v", vcUrn), -1)
...
/*
VirtualCenterApiService Retrieve the VMCA certificate
...
@return VCenterVmca
*/
func (a *VirtualCenterApiService) RetrieveVsphereVmca(ctx context.Context, vcUrn string) (VCenterVmca, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue VCenterVmca
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/virtualCenters/{vcUrn}/certificateAuthority/vmca"
	localVarPath = strings.Replace(localVarPath, "{"+"vcUrn"+"}", fmt.Sprintf("%v", vcUrn), -1)
