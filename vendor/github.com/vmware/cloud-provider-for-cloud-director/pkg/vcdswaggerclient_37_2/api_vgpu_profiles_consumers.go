...
type VgpuProfilesConsumersApiService service

/*
VgpuProfilesConsumersApiService Get list of vGPU profiles consumer entities
 ...
 * @param optional nil or *VgpuProfilesConsumersApiQueryVgpuProfilesConsumersOpts - Optional Parameters:
...
@return VgpuConsumerEntities
*/

type VgpuProfilesConsumersApiQueryVgpuProfilesConsumersOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *VgpuProfilesConsumersApiService) QueryVgpuProfilesConsumers(ctx context.Context, page int32, pageSize int32, localVarOptionals *VgpuProfilesConsumersApiQueryVgpuProfilesConsumersOpts) (VgpuConsumerEntities, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue VgpuConsumerEntities
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vgpuProfiles/consumers"
